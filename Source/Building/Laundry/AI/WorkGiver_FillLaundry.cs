...
namespace Astrologer.Laundry
{
    ...
    public abstract class WorkGiver_FillLaundryRepair : WorkGiver_Scanner
    {
        ...
        protected virtual JobDef FillJob => AstDefOf.AS_Job_FillLaundry;
        ...
        public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            List<Building> laundrys = pawn.Map.listerBuildings.AllBuildingsColonistOfDef(AstDefOf.AS_Laundy);
